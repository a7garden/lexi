...
1. [Releases](https://github.com/a7garden/lexi/releases/latest)에서 최신 `Lexi-*-macOS-arm64.dmg`를 받습니다.
2. DMG를 열고 `Lexi.app`을 응용 프로그램 폴더로 드래그 앤 드롭해 설치합니다.
...
이 저장소는 [MIT 라이선스](LICENSE)로 배포됩니다.
